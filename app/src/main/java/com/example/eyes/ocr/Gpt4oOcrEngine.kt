...
class Gpt4oOcrEngine : OcrEngine {
    ...
    private fun buildRequestBody(model: String, imageDataUrl: String): String {
        val systemPrompt = "Bạn là OCR tiếng Việt. Trích xuất văn bản chính xác, giữ nguyên dấu tiếng Việt, không diễn giải thêm."
        val userPrompt = "Hãy trả về toàn bộ văn bản nhìn thấy trong ảnh. Không thêm nhận xét."
